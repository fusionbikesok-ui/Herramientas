    ...
    const tx = db.transaction(() => {
      ...
      if (!activo) {
        ...
        insertarHistorial.run(
          ...
          JSON.stringify({ severidad: severidadPedida, mensajeHumano: mensaje, mensajeTecnico: mensajeTecnico ?? null, contexto: contextoLimpio }),
          ts
        );
...
function enteroValido(valor, porDefecto, tope = Number.MAX_SAFE_INTEGER) {
