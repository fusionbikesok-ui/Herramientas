...
import { auditarIdentidadProductos } from './identidadProductos.js';
  ...
  for (const job of jobs) {
    try {
      ...
      if (job.job_type === 'question.project') {
        ...
        // El catálogo cambió: reabre localmente cualquier identidad ML cuyo SKU Woo dejó de
        // existir. No escribe ML; la próxima lectura ML completa conserva su propia frescura.
        auditarIdentidadProductos(db, 'webhook_woo_producto', { lecturaConfiable: false });
