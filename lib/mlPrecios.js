...
export async function costoEnvioMl(db, mlCfg, itemId, freeShipping, cache = null, opts = {}) {
...
export async function netoMl(db, mlCfg, { itemId, price, categoryId, listingTypeId, freeShipping }, caches = {}, opts = {}) {
  ...
  const envio = await costoEnvioMl(db, mlCfg, itemId, freeShipping, caches.envio, opts);
