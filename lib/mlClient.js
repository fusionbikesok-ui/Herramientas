...
/**
 * Clasifica un error de ML en una de 5 categorías reportables (incidente 2026-08-27, plan de
 ...
 * `datos` (400/404/422/etc. — ML rechazó la request en sí, un producto/payload puntual, no debe
 * frenar el resto del lote ni activar el cooldown de forma desproporcionada), `interno` (excepción
 * no-HTTP: bug propio, parseo, etc.).
 *
