...
function construirWC(items){
  ...
  for(const r of items){
    ...
    const attrs=extraerAtributosWC(nombre);
...
const api={EQUIV,COLORES,TALLE_RE,norm,toks,extraerAtributos,extraerAtributosWC,attrScore,lcsLen,ratio,tsr,intersecta,construirWC,ctDesdeApi,getCandidatos,candidatosDeItem,djb2,TOPE_CANDIDATOS};
