...
Completar gates de E1: revisar el candidato UI `6ce89a7` en `/tmp/fusion-e1-preparacion-ui`, ejecutar E2E responsive/axe, resolver o aceptar explícitamente la ausencia de claims en `GET /api/jornada/olas`, y realizar piloto/jornada observada. No desplegar runtime mientras E1 siga en desarrollo.
