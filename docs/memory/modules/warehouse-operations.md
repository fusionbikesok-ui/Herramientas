...
- E19 inició su núcleo durable en `warranty_cases`/`warranty_events`: alta idempotente,
  ...
  consumo/liberación en el ledger, carga real de adjuntos, Woo, UI y E2E; el ciclo local de
  compromiso ya permite liberar o consumir con versión e idempotencia.
