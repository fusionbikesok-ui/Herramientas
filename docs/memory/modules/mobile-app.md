...
adaptador al contrato móvil. El VPS ya lo expone en `ca2d2c0`, pero el cliente aún debe enviar
el binario multipart de la URI local y validarlo en dispositivo real.
