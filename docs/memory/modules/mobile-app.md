...
Los commits `36a1d28`, `514605e` y `86bfb8d` agregan el cliente tipado, la pantalla móvil inicial
de taller y una cola offline ordenada, con retención de siete días y detención ante conflictos.
No hay build publicada; falta integrar SecureStore, captura real y validar `/api/v1` en un iPhone.
