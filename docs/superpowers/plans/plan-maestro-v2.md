...
En Recuperar ventas, la oportunidad estará vigente hasta el cierre de la tienda; si aparece fuera de horario, se trasladará a la siguiente jornada hábil. Los intentos se consolidarán por cliente mediante identificador, email o teléfono: varios fallidos se muestran como una sola oportunidad. Si el cliente concreta un pedido exitoso, la oportunidad y sus intentos fallidos dejan de mostrarse en Recuperar ventas, aunque permanecen en el historial. Los únicos canales de contacto serán WhatsApp y Email, cada uno con su botón. Otro botón permitirá marcar el contacto como realizado. Se registrará el estado nunca contactado/contactado, usuario, fecha, hora y canal; seleccionar un canal por sí solo registra el intento, no confirma el contacto.
