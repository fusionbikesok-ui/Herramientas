...
Los pedidos en espera durante más de un día tendrán atención especial y mostrarán la antigüedad y el riesgo de estar reservando stock sin pago confirmado. La interfaz priorizará revisar pago, contactar al cliente y decidir la reserva; no liberará ni cancelará automáticamente hasta definir la regla correspondiente.
