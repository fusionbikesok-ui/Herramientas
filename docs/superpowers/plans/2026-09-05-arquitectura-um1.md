...
5. **Media:** completar reactivación/cierre ML y archivado de identidades.
6. **Media:** formalizar outbox, dead-letter y métricas de eventos perdidos.
7. **Baja:** retirar comentarios y nombres legacy que describen saga con stock cero o cron de cinco minutos cuando ya no sean el objetivo.
