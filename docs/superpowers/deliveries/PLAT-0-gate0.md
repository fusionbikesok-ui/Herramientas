...
- Entrega / estado: **en curso** (backups B2, disco, monitoreo externo, Node 24 y QA bajo demanda cumplidos; PITR pendiente: llega con PostgreSQL)
...
- Próxima acción exacta y reproducible: Gate 0 cerrado salvo PITR (depende de PostgreSQL en P1). QA: `scripts/qa/qa.sh up|down|status` (plan `2026-09-13-qa-bajo-demanda.md`). Antes de ~8 GB en el bucket B2 decidir tarjeta, lifecycle o proveedor.
