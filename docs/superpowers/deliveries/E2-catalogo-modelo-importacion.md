...
**Estado:** tramo 1 (modelos y variantes) desplegado en producción el 2026-09-20; **tramo 2 (atributos, imágenes y datos comerciales) desplegado en producción el 2026-09-20** (migración `0014`, worker recreado, backfill de las 12.850 representaciones ejecutado; la comparación entre canales se encendió el mismo día, `CATALOGO_COMPARAR_ATRIBUTOS=1`); **tramo 3 (taxonomía propia, marcas, colecciones, packs y kits) implementado en sombra el 2026-09-20**, sin desplegar: migración `0015` escrita y verificada contra el contrato, las 8 tareas del plan cerradas (`docs/superpowers/plans/2026-09-20-e2-tramo3-taxonomia-colecciones-packs.md`) y las cuatro decisiones D1–D4 tomadas por José con la jerarquía real a la vista.
...
- **Próxima acción exacta:** correr las dos suites completas en serie, sin nadie más trabajando, y recién después desplegar el tramo 3 (migración `0015` + recrear el worker). La migración es aditiva y con columnas nullable: el código viejo sigue funcionando y no hay nada que escribir en ningún canal.
