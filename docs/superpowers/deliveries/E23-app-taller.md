# E23 — Taller en iPhone

**Estado:** borrador

**Dependencias:** E18, E21
...
- Taller móvil completa diagnóstico, repuestos, estado y evidencia online/offline.
- **Incluye:** Paridad con E18, cámara, escaneo, cola offline y deep links.
- **No incluye:** No modifica dominio ni política de stock.
- **Evidencia histórica absorbida:** E21 histórico. Es evidencia, no aceptación automática.

## Línea base verificada

- Existe API móvil legacy de workshop; debe quedar como fachada o retirarse tras OTA.
...
- Repuesto usado offline puede colisionar con stock; conflicto bloquea cierre.

## Diseño, datos e interfaces

- **Modelo:** Operaciones E21 vinculadas a workshop jobs/parts v2.
- **Interfaces:** API v2 E18 y fachada /api/v1/workshop compatible durante migración.
...
- **Migración:** OTA gradual; métricas confirman abandono v1 antes de deprecación.
...
- **Comando contractual:** npm run test:e23 y suite App; offline, conflicto, fotos, revocación e iPhone real.
- El comando `npm run test:e23` debe existir antes de pasar a `desarrollo`; no puede ser un alias vacío y debe fallar si falta un escenario obligatorio.
...
- **Despliegue:** Un técnico/dispositivo, jornada observada y rollback OTA.
...
- **Aceptación técnica y operativa:** Orden completa móvil reconciliada con stock y Woo.
- Código construido pero no usado no cuenta como observado; publicación no equivale a aceptación.

## Continuidad

- **Próxima acción exacta:** Auditar workshopApi actual y fijar crosswalk de endpoints.
