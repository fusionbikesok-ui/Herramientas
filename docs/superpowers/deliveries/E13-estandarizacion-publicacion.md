...
- Lotes aprobados se publican en Woo, se verifican y pueden compensarse.
- **Incluye:** Comandos auditados, simulador, canario y campaña por categoría.
- **No incluye:** No modifica contenido/precios ML ni storefront.
- **Evidencia histórica absorbida:** P5.4–P5.5. Es evidencia, no aceptación automática.

## Línea base verificada

- Woo es el único destino de escritura de esta etapa.
...
- Fallo parcial produce estado bloqueado y compensación explícita, nunca rollback ciego.

## Diseño, datos e interfaces

- **Modelo:** publication_batches, commands, attempts, remote_evidence y compensations.
- **Interfaces:** Aprobar, ejecutar, consultar y compensar lote; idempotencia y reautenticación reciente.
...
- **Migración:** No masiva inicial: lotes pequeños con snapshot previo y post-verificación.
...
- **Comando contractual:** npm run test:e13; 403/408/429/5xx, respuesta incierta, parcial, compensación y fixture Woo.
- El comando `npm run test:e13` debe existir antes de pasar a `desarrollo`; no puede ser un alias vacío y debe fallar si falta un escenario obligatorio.
...
- **Despliegue:** QA, una categoría canaria, expansión por métricas; abortar ante diferencia no explicada.
...
- **Aceptación técnica y operativa:** 100 % de escrituras verificadas y jornada de revisión/publicación aceptada.
