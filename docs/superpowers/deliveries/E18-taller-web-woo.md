...
- Taller consume repuestos del libro y genera servicios/ventas Woo verificadas.
- **Incluye:** Orden de taller, diagnóstico, presupuesto, partes, estados, evidencia y efecto Woo.
- **No incluye:** La App de taller pertenece a E23.
- **Evidencia histórica absorbida:** E20 histórico. Es evidencia, no aceptación automática.

## Línea base verificada

- Backend/pantalla legacy existen y workshop_jobs tiene 0 filas.
...
- Repuesto reservado/usado/no usado produce movimientos diferentes; venta incierta se reconcilia.

## Diseño, datos e interfaces

- **Modelo:** Workshop jobs, parts, events y comandos vinculados a variantes/stock canónicos.
- **Interfaces:** API/UI v2 con idempotencia, permisos y estado de efectos Woo.
...
- **Migración:** Sin filas productivas; adaptar código sólo después de pruebas del nuevo dominio.
...
- **Comando contractual:** npm run test:e18; presupuesto, repuesto, devolución, garantía, caída Woo y E2E.
- El comando `npm run test:e18` debe existir antes de pasar a `desarrollo`; no puede ser un alias vacío y debe fallar si falta un escenario obligatorio.
...
- **Despliegue:** Orden controlada completa y rollback por flag sin borrar eventos.
...
- **Aceptación técnica y operativa:** Servicio observado con stock y Woo reconciliados.
