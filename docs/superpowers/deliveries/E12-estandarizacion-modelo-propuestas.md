...
- Plantillas versionadas generan propuestas revisables de normalización sin publicar cambios.
- **Incluye:** Categoría primaria, marca, colecciones, vocabularios, unidades, atributos requeridos/recomendados, facetas y descripción de imágenes.
- **No incluye:** No cambia storefront ni publica en Woo.
- **Evidencia histórica absorbida:** P5.1–P5.3. Es evidencia, no aceptación automática.

## Línea base verificada

- catalogo_cache registra 154 marcas y 126 filas con atributos vacíos al snapshot.
...
- Nunca inventar atributos sin evidencia; sugerencias automáticas requieren confianza visible y aprobación humana.

## Diseño, datos e interfaces

- **Modelo:** category_templates, template_versions, vocabularies, normalization_proposals, proposal_diffs y approvals.
- **Interfaces:** API/UI v2 para lotes, diff, aprobación/rechazo y explicación; sólo catálogo/administración.
...
- **Migración:** Importar valores existentes preservando original y procedencia; inválidos generan propuesta, no sobrescritura.
...
- **Comando contractual:** npm run test:e12; versionado, vocabularios, diff estable, dos revisores y E2E WCAG.
- El comando `npm run test:e12` debe existir antes de pasar a `desarrollo`; no puede ser un alias vacío y debe fallar si falta un escenario obligatorio.
...
- **Despliegue:** Primera categoría acotada, sin escritor remoto; rollback archivando propuestas.
...
- **Aceptación técnica y operativa:** Cobertura antes/después medible y ningún lote aprobado sin actor/evidencia.
