...
- Etiqueta interna 50×25 se imprime mediante agente autenticado, idempotente y observable.
- **Incluye:** Cola, claim/lease, resultado, reimpresión, permisos y hardware real.
- **No incluye:** No rediseña preparación.
- **Evidencia histórica absorbida:** E3 histórico. Es evidencia, no aceptación automática.

## Línea base verificada

- 62 etiquetas pendientes en medición previa; migración 049 y backend existen, falta agente/hardware aceptado.
...
- Impresora apagada/sin papel/USB; reintento nunca duplica etiqueta confirmada.

## Diseño, datos e interfaces

- **Modelo:** Print jobs y attempts con lease, device, hash y resultado.
- **Interfaces:** API v2 de agente con JWT de dispositivo y permiso etiquetas; payload versionado.
...
- **Migración:** Importar cola pendiente sólo tras validar vigencia; duplicados por fingerprint.
...
- **Comando contractual:** npm run test:e24; suite backend, agente Windows y prueba física de impresora/red/USB.
- El comando `npm run test:e24` debe existir antes de pasar a `desarrollo`; no puede ser un alias vacío y debe fallar si falta un escenario obligatorio.
...
- **Despliegue:** Una estación, lote de prueba y ampliación tras confirmación.
...
- **Aceptación técnica y operativa:** Cola drena, reimpresión controlada y hardware aceptado.
