...
Un pedido en estado de espera por más de un día tendrá una marca de **atención especial**, con antigüedad visible y alerta de posible reserva de stock sin pago confirmado. No se liberará ni cancelará automáticamente sin una regla aprobada, pero quedará priorizado para revisión de pago, contacto y decisión sobre la reserva.
