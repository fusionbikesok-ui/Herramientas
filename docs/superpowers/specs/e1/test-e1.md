...
| E1-PGDOWN-01 | reparación tras caída | PostgreSQL detenido 10 min con tráfico | pérdidas contadas en `shadow_copy_losses`; barridos reparan el 100 % de lo enumerable; envíos convergen en un barrido | queda faltante |
