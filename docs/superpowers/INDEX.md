...
- [Tramo 2 — diseño](specs/2026-09-15-e1-tramo2-barridos-design.md) y [plan](plans/2026-09-15-e1-tramo2-barridos.md): aprobados para implementación exclusivamente efímera; cortes 1–4 implementados, falta 5 (contrato acumulativo) y cerrar las brechas de adaptadores anotadas en la memoria activa.
